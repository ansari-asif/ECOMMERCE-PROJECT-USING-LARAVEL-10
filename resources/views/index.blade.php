                  ...
                  <!-- start prduct navigation -->
                   <ul class="nav nav-tabs aa-products-tab">
                    @php
                        $j=0;
                    @endphp
                      @foreach ($products as $item=>$category)
                        <li class="@if($j==0)active @endif"><a href="#tab_{{$item}}" data-toggle="tab">{{ $category[0]->category->name}} </a></li>
                        @php
                            $j++;
                        @endphp
                      @endforeach
                    ...
                    <div class="tab-content">
                      ...
                      @php
                        $i=0;
                      @endphp
                      @foreach ($products as $item => $productCategory)
                      <div class="tab-pane fade in @if($i==0) active @endif" id="tab_{{$item}}">
                        <ul class="aa-product-catg">
                          <!-- start single product item -->
                          @foreach ($productCategory as $product)
                          <li>
                            <figure>
                              <a class="aa-product-img" href="#"><img src="https://via.placeholder.com/250x300.png/?text={{$product->name}}" alt={{$product->name}}></a>
                              <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                <figcaption>
                                <h4 class="aa-product-title"><a href="#">{{$product->name}} </a></h4>
                                <span class="aa-product-price">${{$product->price}}</span><span class="aa-product-price"><del>${{$product->price}}</del></span>
                              </figcaption>
                            </figure>                        
